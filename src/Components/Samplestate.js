    ...
    <div className="bg-gradient-to-br from-pink-300 to-purple-500 p-4 rounded-md shadow-md hover:shadow-lg transition-shadow transform hover:scale-105">
      <div className="flex flex-col items-center">
        ...
        <h2 className="text-2xl font-semibold mb-2 text-white">
          <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" className="hover:text-purple-400">
            {name}
          </a>
        </h2>
      ...
      <button className="mt-4 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-full focus:outline-none w-full">
        Contact
      </button>
    </div>
  );
